...
fluid.defaults("gpii.tests.pouchdb.component.node.caseHolder", {
    ...
    rawModules: [{
        ...
        tests: [
            {
                name: "Confirm that onDataLoaded is fired if we have no data...",
                sequence: [
                    {
                    ...
                    },
                    {
                        ...
                        args:    ["onDataLoaded should be fired even if we have no data..."]
                    }
                ]
            },
            {
        ...
        tests: [
            {
                ...
                sequence: [
                    /*
                        I know the component will already exist, but if I don't have this step, I get errors like:
